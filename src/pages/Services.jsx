...
export default function Services() {
  ...
  const handleSave = async (id) => {
    // 🛡️ Security Barrier
    if (isStaff) return triggerPopup("Unauthorized: Only owners can modify services.");
      ...
      <div className="min-h-screen bg-app-light p-2">
        ...
        <div className="max-w-6xl mx-auto px-1 md:px-2">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            {/* --- ✨ FIX: Hide the ADD button completely for Staff --- */}
            {!isStaff && (
              <button
          ...
          <LayoutGroup>
            ...
            <div className="relative z-[20] mb-3">
              <LoyaltySettings userRole={userRole} />
            </div>
